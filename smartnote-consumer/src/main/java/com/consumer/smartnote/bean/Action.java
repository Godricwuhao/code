...
public class Action extends GeneratedMessageV3 implements ActionOrBuilder {
            ...
            while (!done) {
                ...
                switch (tag) {
                    ...
                    case 104:
                        ...
                        break;
                    case 114:
                        this.webBrowser_ = input.readStringRequireUtf8();
                        break;
                    case 122:
    ...
    public static enum ActionType implements ProtocolMessageEnum {
        ...
        private static final Internal.EnumLiteMap<ActionType> internalValueMap = new Internal.EnumLiteMap() {
            public Action.ActionType findValueByNumber(int number) {
                return Action.ActionType.forNumber(number);
            }
        };
    ...
    public static enum TargetSource implements ProtocolMessageEnum {
        ...
        private static final Internal.EnumLiteMap<TargetSource> internalValueMap = new Internal.EnumLiteMap() {
            public Action.TargetSource findValueByNumber(int number) {
                return Action.TargetSource.forNumber(number);
            }
        };
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements ActionOrBuilder {
        ...
        public Action.ActionType getType() {
            Action.ActionType result = Action.ActionType.valueOf(this.type_);
            return result == null ? Action.ActionType.UNRECOGNIZED : result;
        }

        public Builder setType(Action.ActionType value) {
            if (value == null) {
                throw new NullPointerException();
            }
        ...
        public Action.TargetSource getTargetSource() {
            Action.TargetSource result = Action.TargetSource.valueOf(this.targetSource_);
            return result == null ? Action.TargetSource.UNRECOGNIZED : result;
        }

        public Builder setTargetSource(Action.TargetSource value) {
            if (value == null) {
                throw new NullPointerException();
            }
